...
export const momentFromTimeOfDay = (time_of_day: number, day_of_month: Moment = moment()): Moment => {
...
export const dateFromSecondsPer24HR = (seconds: number, current_date: number = Date.now()): number => {
